...
def train(args, train_dataset, model, tokenizer, mode):
    """ Train the model """
...
class Arguments():
    # Note that mant of the arguments don't work
...
def main(model, tokenizer, mode):
    ...
    if args.do_train:
        ...
        global_step, tr_loss = train(args, train_dataset, model, tokenizer,mode)
